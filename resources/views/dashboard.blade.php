            ...
            <div class="col-6 col-md-3 col-xl-2 col-lg-3">
                <a class="block block-rounded block-bordered block-link-shadow text-center" href="javascript:void(0)" data-toggle="click-ripple">
                    <div class="block-content text-muted">
                        ...
                        <p class="font-w600">Change requests</p>
                    </div>
                </a>
            </div>
            <div class="col-6 col-md-3 col-xl-2 col-lg-3">
                <a class="block block-rounded block-bordered block-link-shadow text-center" href="javascript:void(0)" data-toggle="click-ripple">
                    <div class="block-content text-muted">
                        ...
                        <p class="font-w600">Approved requests</p>
                    </div>
                </a>
            </div>
            <div class="col-6 col-md-3 col-xl-2 col-lg-3">
                    ...
                    <div class="block-content">
                        <div class="px-sm-3 pt-sm-3 clearfix" style="min-height: 213px;">
                            ...
                            <p class="display-4 text-primary font-w300 mb-2">
                                15 <span class="font-size-h5 font-w600 text-muted">contracten</span>
                            </p>
                            <div class="pt-3">
                                <p class="text-muted w-75 text-muted">
                ...
                <div class="block block-bordered mb-lg-2">
                    <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                        <div class="ml-3">
                            ...
                            <a class="link-fx font-size-sm font-w600 text-muted text-uppercase mb-0"
